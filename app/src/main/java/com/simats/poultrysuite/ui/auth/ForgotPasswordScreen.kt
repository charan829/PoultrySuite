...
fun ForgotPasswordScreen(
    ...
    val canSubmit = email.isNotBlank() &&
        ...
        forgotPasswordState !is ForgotPasswordState.Loading
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Enter your registered email and set a new password.",
            ...
            Button(
                onClick = {
                    viewModel.forgotPassword(email = email, newPassword = newPassword)
                },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(50.dp),
